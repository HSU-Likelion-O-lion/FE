  ...
  return (
    <main className="relative mx-auto min-h-dvh w-full max-w-[430px] overflow-x-hidden overflow-y-auto bg-[#f7f8fc]">
      <div className="relative mx-auto min-h-[max(852px,100dvh)] w-full">
        ...
        {/* Ellipse 2467 — Figma: 433×644, left -20, top -230 (화면보다 큼) */}
        <img
          src={bgGlow}
          alt=""
          className="pointer-events-none absolute left-[-20px] top-[-230px] z-20 h-auto w-[calc(100%+40px)] max-w-none"
        />

        <header className="pointer-events-none absolute inset-x-0 top-0 z-40 flex h-11 items-center justify-center px-5">
          <button
            type="button"
            aria-label="뒤로가기"
            onClick={onBack}
            className="pointer-events-auto absolute left-5 flex size-6 items-center justify-center"
          >
            <img
              src={iconBack}
              alt=""
        ...
        <div className="pointer-events-none absolute left-[calc(50%-65px)] top-[66px] z-40 -translate-x-1/2 rounded-tl-xl rounded-tr-xl rounded-bl-xl bg-primary-10 px-4 py-[9.6px]">
        ...
        <img
          src={emptyOwlPeek}
          alt=""
          className="pointer-events-none absolute left-[calc(50%+18px)] top-[112px] z-40 h-[82px] w-[154px] object-contain object-bottom"
        />
