    ...
    <main className="relative mx-auto min-h-dvh w-full max-w-[430px] overflow-x-hidden overflow-y-auto bg-[#f7f8fc]">
      <div className="relative mx-auto min-h-[max(852px,100dvh)] w-full">
        ...
        <img
          src={bgGlow}
          alt=""
          className="pointer-events-none absolute left-[-20px] top-[-230px] z-30 h-auto w-[calc(100%+40px)] max-w-none"
        />
        ...
        <img
          src={owlMascot}
          alt=""
          className="pointer-events-none absolute left-[calc(50%+31px)] top-[46px] z-40 h-[144px] w-[132px] object-contain object-bottom"
        />
